document.addEventListener("DOMContentLoaded", () => {
  ...
  function hideAllSections() {
    ...
    buttons.forEach((button) => {
      ...
      button.style.color = "#333"; // Dark gray font
      button.style.border = "2px solid #333"; // Dark gray border
    });
  }

  function styleButton(button) {
    button.style.backgroundColor = "#D3D3D3"; // Light gray background
    button.style.color = "#333"; // Dark gray font color
    button.style.border = "2px solid #333"; // Dark gray border
  ...
  function createButton(button, label, section) {
    ...
    button.addEventListener("click", () => {
      ...
      button.style.backgroundColor = "#A9A9A9"; // Medium gray background for active button
      button.style.border = "2px solid #333"; // Dark gray border to match
    });
